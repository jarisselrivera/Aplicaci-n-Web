                ...
                <div class="d-table-cell align-middle">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Registrar Alumno</h5>
                        </div>
                        <div class="card-body">
                            <div class="m-sm-4">
                                <form class="form-horizontal" enctype="multipart/form-data" action="javascript:void(0)" id="frm-agregar-estudiante">
                                    <div class="mb-3">
...
<script>
    $(function() {
        ...
        $('#frm-agregar-estudiante').validate();

        //Envio de la imagen con Ajax
        $('#frm-agregar-estudiante').on('submit', function(e) {
            e.preventDefault();

            var dataFormulario = new FormData(this);

            $.ajax({
                url: "<?= base_url('public/estudiante/salvarEstudiante') ?>",
                type: "POST",
                cache: false,
                data: dataFormulario,
                processData: false,
                ...
                success: function(data) {
                    if (data.success == true) {
                        Swal.fire('Ingresado', 'Estudiante ingresado', 'success').then(function() {
